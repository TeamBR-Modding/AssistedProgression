 ...
 * @since 11/10/17
 */
public class GrinderRecipeHandler extends AbstractRecipeHandler<GrinderRecipe, ItemStack, Pair<Pair<ItemStack, ItemStack>, Integer>> {
    ...
    protected void generateDefaultRecipes() {
        ...
        addRecipe(new GrinderRecipe("oreRedstone",
                "dustRedstone:12", "dustRedstone:4",
                20));
        addRecipe(new GrinderRecipe("oreLapis",
                "gemLapis:8", "gemLapis:2",
                20));
        addRecipe(new GrinderRecipe(getItemStackString(new ItemStack(Items.BLAZE_ROD)),
                getItemStackString(new ItemStack(Items.BLAZE_POWDER, 4)), getItemStackString(new ItemStack(Items.BLAZE_POWDER, 2)),
                15));
        addRecipe(new GrinderRecipe("cobblestone",
                "sand:2", "gravel:1",
                10));
        addRecipe(new GrinderRecipe("sand", "gravel:2", "", 0));
        addRecipe(new GrinderRecipe("bone",
                ...
                10));
        addRecipe(new GrinderRecipe("oreQuartz", "gemQuartz:4", "gemQuartz:2",
                50));
        addRecipe(new GrinderRecipe(getItemStackString(new ItemStack(Blocks.CLAY)),
                getItemStackString(new ItemStack(Items.CLAY_BALL, 4)), getItemStackString(new ItemStack(Items.CLAY_BALL, 2)),
                25));
        addRecipe(new GrinderRecipe(getItemStackString(new ItemStack(Blocks.HARDENED_CLAY)),
                getItemStackString(new ItemStack(Items.BRICK, 4)), "", 0));
        addRecipe(new GrinderRecipe("oreDiamond", "gemDiamond:2", "gemDiamond:1",
                10));
        addRecipe(new GrinderRecipe("oreEmerald", "gemEmerald:2", "gemEmerald:1",
                10));
        addRecipe(new GrinderRecipe("glowstone", "dustGlowstone:4", "dustGlowstone:2",
                15));
        addRecipe(new GrinderRecipe("oreCoal",
                getItemStackString(new ItemStack(Items.COAL, 3)), getItemStackString(new ItemStack(Items.DIAMOND, 1)),
                1));
        addRecipe(new GrinderRecipe("minecraft:wool:" + OreDictionary.WILDCARD_VALUE + ":1",
                getItemStackString(new ItemStack(Items.STRING, 4)), "", 0));
        addRecipe(new GrinderRecipe("blockGlass", "sand:1", "", 0));
        addRecipe(new GrinderRecipe("gravel",
